...
FEELDIR  = FEEL
FEELOBJ  = $(FEELDIR)/Object/error.o $(FEELDIR)/Object/winmain.o
FeFileDIR  = FeFile
...
FLAGS = -IInclude -IFeDX/Include -IFEEL/Include -IFeFile/Include -IFeIO/Include -IFELL/Include -IFeMath/Include -IFeWin/Include -ffast-math -O3 -ffast-math -fvtable-thunks
