...
#define UNICORNHORN (FIRSTMATERIAL + 19)
#define DIAMOND (FIRSTMATERIAL + 20)
#define SILVER (FIRSTMATERIAL + 21)
#define SAPPHIRE (FIRSTMATERIAL + 22)
#define RUBY (FIRSTMATERIAL + 23)
#define BRONZE (FIRSTMATERIAL + 24)
#define COPPER (FIRSTMATERIAL + 25)
#define TIN (FIRSTMATERIAL + 26)
#define STEEL (FIRSTMATERIAL + 27)
...
#define FIRSTPOWDER (4096 * 6)
#define GUNPOWDER (FIRSTPOWDER + 1)
...
#define BOOTOFSTRENGTH 1
#define BOOTOFAGILITY 2

#define GAUNTLETOFSTRENGTH 1
#define GAUNTLETOFDEXTERITY 2
...
#define HELMOFPERCEPTION 1
#define HELMOFUNDERSTANDING 2
#define HELMOFBRILLIANCE 3
#define HELMOFATTRACTIVITY 4
