...
#define VALPURIUM (MATERIAL_ID + 1)
#define STONE (MATERIAL_ID + 2)
#define GRAVEL (MATERIAL_ID + 3)
#define MORAINE (MATERIAL_ID + 4)
#define OCTIRON (MATERIAL_ID + 5)
#define GLASS (MATERIAL_ID + 6)
#define PARCHMENT (MATERIAL_ID + 7)
#define CLOTH (MATERIAL_ID + 8)
#define MITHRIL (MATERIAL_ID + 9)
#define MARBLE (MATERIAL_ID + 10)
#define GOLD (MATERIAL_ID + 11)
#define GRASS (MATERIAL_ID + 12)
#define LEATHER (MATERIAL_ID + 13)
#define LEAF (MATERIAL_ID + 14)
#define FABRIC (MATERIAL_ID + 15)
#define PALM_LEAF (MATERIAL_ID + 16)
#define SULFUR (MATERIAL_ID + 17)
#define UNICORN_HORN (MATERIAL_ID + 18)
#define DIAMOND (MATERIAL_ID + 19)
#define SILVER (MATERIAL_ID + 20)
#define SAPPHIRE (MATERIAL_ID + 21)
#define RUBY (MATERIAL_ID + 22)
#define BRONZE (MATERIAL_ID + 23)
#define COPPER (MATERIAL_ID + 24)
#define TIN (MATERIAL_ID + 25)
#define SPIDER_SILK (MATERIAL_ID + 26)
#define KEVLAR (MATERIAL_ID + 27)
#define OMMEL_HAIR (MATERIAL_ID + 28)
#define HARDENED_LEATHER (MATERIAL_ID + 29)
#define TROLL_HIDE (MATERIAL_ID + 30)
#define NYMPH_HAIR (MATERIAL_ID + 31)
#define ANGEL_HAIR (MATERIAL_ID + 32)
#define PHOENIX_FEATHER (MATERIAL_ID + 33)
#define GOLDEN_EAGLE_FEATHER (MATERIAL_ID + 34)
#define ICE (MATERIAL_ID + 35)
#define DRAGON_HIDE (MATERIAL_ID + 36)
#define ARCANITE (MATERIAL_ID + 37)
#define ILLITHIUM (MATERIAL_ID + 38)
#define BALSA_WOOD (MATERIAL_ID + 39)
#define PINE_WOOD (MATERIAL_ID + 40)
#define FIR_WOOD (MATERIAL_ID + 41)
#define BIRCH_WOOD (MATERIAL_ID + 42)
#define OAK_WOOD (MATERIAL_ID + 43)
#define TEAK_WOOD (MATERIAL_ID + 44)
#define EBONY_WOOD (MATERIAL_ID + 45)
#define BLUE_CRYSTAL (MATERIAL_ID + 46)
#define PURPLE_CRYSTAL (MATERIAL_ID + 47)
#define GREEN_CRYSTAL (MATERIAL_ID + 48)
#define DARK_GRASS (MATERIAL_ID + 49)
...
#define CARROT_FLESH (ORGANIC_SUBSTANCE_ID + 11)
