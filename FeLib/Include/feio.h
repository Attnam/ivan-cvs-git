...
{
 public:
  static std::string ContinueMenu(ushort, ushort, const std::string&);
  ...
  static long ScrollBarQuestion(const std::string&, vector2d, long, long, long, long, long, ushort, ushort, ushort, bool, void (*)(long) = 0);
